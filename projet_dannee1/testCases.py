...
class TestSequenceFunctions(unittest.TestCase):
	...
	def test_checkMove(self):
		...
		for test in tests:
			...
			if(success):
				...
				x=checkMove(board,y,x,direction,player,length,hasPlayer,hasCaptured)
				success = x == eval(final)
	...
	def moveHelper(self,board,args):
		...
		if(cap != None):
			...
			capture(board,capY,capX)
		becomeKing(board,y,x)
		endofgame1=checkEndOfGame(board,WHITE_PLAYER)
		dic1=dic['WHITE_END']
		endofgame2=checkEndOfGame(board,BLACK_PLAYER)
		dic2=dic['BLACK_END']
		white=self.same(checkEndOfGame(board,WHITE_PLAYER),dic['WHITE_END'])
		black=self.same(checkEndOfGame(board,BLACK_PLAYER),dic['BLACK_END'])
		print("WHITE_END "+str(white))
		print("BLACK_END "+str(black))
		print("endofgame1 "+str(endofgame1))
		print("dic1 "+str(dic1))
		print("endofgame2 "+str(endofgame2))
		print("dic2 "+str(dic2))
		return (
