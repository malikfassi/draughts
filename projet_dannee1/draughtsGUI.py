...
class MessageBox:
    def __init__(self,title,message):
        ...
        :param title: titre du message box
        :param message: message a afficher dans la messagebox
        """
...
def help(title,text):
    ...
    :param title: titre du messageBox
...
class Buttons:
    ...
    def __init__(self,parent):
        """ Initialisation et placements des 4 boutons"""
        self.parent=parent
...
if __name__=="__main__":
    cellSize = 40
    board = Board(cellSize*DIMENSION,cellSize*DIMENSION,cellSize)
    board.config(bg="bisque")
    borderVert=VerticalBorder(board,"center","solid")
    boderHoriz=HorizBorder(board,"center","solid")
    board.title("Draughts")
    buttons=Buttons(board)
    board.mainloop()